...
<cffunction name="renderView" output="false" hint="I render a view and return the resultant HTML.">
	...
	<cfif isDefined("url.log")><cffile action="append" file="C:\inetpub\temp\log.txt" output="#dateTimeFormat(now(),"yyyy-mm-dd HH:mm:ss")# ViewRenderer.cfc - renderView() part check point 0"></cfif>
	<cfset var i = "" />
	<cfset var j = "" />
	...
	<cfif isDefined("url.log")><cffile action="append" file="C:\inetpub\temp\log.txt" output="#dateTimeFormat(now(),"yyyy-mm-dd HH:mm:ss")# ViewRenderer.cfc - renderView() part check point 1"></cfif>
	...
	<cfif isDefined("url.log")><cffile action="append" file="C:\inetpub\temp\log.txt" output="#dateTimeFormat(now(),"yyyy-mm-dd HH:mm:ss")# ViewRenderer.cfc - renderView() part check point 2"></cfif>
	...
	<cfif isDefined("url.log")><cffile action="append" file="C:\inetpub\temp\log.txt" output="#dateTimeFormat(now(),"yyyy-mm-dd HH:mm:ss")# ViewRenderer.cfc - renderView() part check point 3"></cfif>
	...
	<cfif isDefined("url.log")><cffile action="append" file="C:\inetpub\temp\log.txt" output="#dateTimeFormat(now(),"yyyy-mm-dd HH:mm:ss")# ViewRenderer.cfc - renderView() part check point 4 - #arguments.view.template#"></cfif>
	...
	<cfif isDefined("url.log")><cffile action="append" file="C:\inetpub\temp\log.txt" output="#dateTimeFormat(now(),"yyyy-mm-dd HH:mm:ss")# ViewRenderer.cfc - renderView() part check point 5 - #arguments.view.template#"></cfif>
	<cfreturn result />
	<!---
	<cfset var result = "" />
	<cfset var v = "" />

...
<cffunction name="init" output="false">
    ...
    <cfset variables._instance.performanceLog = "false" />
...
<cffunction name="setPerformanceLog" returntype="void" output="false" access="public">
	<cfargument name="PerformanceLog"  type="boolean" />
	<cfset variables._instance.PerformanceLog = arguments.PerformanceLog />
</cffunction>
<cffunction name="getPerformanceLog" returntype="boolean" output="false">
	<cfreturn variables._instance.PerformanceLog />
</cffunction>
